...
namespace Adventure14.Views
{
    public partial class Employee : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cboDepartment.Attributes.Add("onclick", "ClearData('" + TextArea1.ClientID + "');");
        }
        ...
        private void DoSearch(string searchValue)
        {
            ...
            string output = new JavaScriptSerializer().Serialize(lstDE);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                TextArea1.Value = "-- Please select Department name.";
            }
        }
    }
}