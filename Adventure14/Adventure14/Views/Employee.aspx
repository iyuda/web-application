                ...
                <tr>
                    <td align="center">
                        <asp:GridView ID="GridView1" runat="server" Width="1000px" AutoGenerateColumns="False" CellPadding="4" Font-Size="14px" ForeColor="#333333" GridLines="None" 
                            OnRowDataBound ="GridView1_RowDataBound" PageSize="15" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging">
                            <AlternatingRowStyle BackColor="White"/>
                            <Columns>
                                <asp:TemplateField HeaderText="Business ID">
                                    <ItemStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="javascript: ClickTheLink(this);" ><%# Eval("BusinessEntityID")%></asp:HyperLink>--%>
