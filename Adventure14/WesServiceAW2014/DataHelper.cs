...
namespace WesServiceAW2014
{
    public class DataHelper
    {
        ...
        public static DataTable getProductView(string culture)
        {
            ...
            using (SqlConnection cn = new SqlConnection(strSQL))
            {
                SqlCommand cmd = new SqlCommand("SELECT * FROM [AdventureWorks2014].[Production].[vProductAndDescription] WHERE CultureID = '" + culture + "'", cn);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
